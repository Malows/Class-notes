        ...
        <tr>
            ...
            {#each data.assignments as a}
                <th class="text-center">
                    ...
                    <a href="/faculties/{facultyId}/subjects/{subjectId}/periods/{periodId}/commissions/{commissionID}/correct?assignment_id={a.id}" class="paper-btn btn-small" data-test-id="correct-assignment-btn-{a.id}">{$t('layout.correct')}</a>
                </th>
            {/each}
        </tr>
    </thead>
